        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          <Card className="workchoque-shadow hover:scale-105 workchoque-transition">
            <CardContent className="p-6 md:p-8 text-center">
              <div className="bg-primary/10 rounded-full p-4 inline-block mb-4 md:mb-6">
                <Target className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-xl font-semibold mb-2 md:mb-4">Diagnósticos Precisos</h3>
          ...
          <Card className="workchoque-shadow hover:scale-105 workchoque-transition">
            <CardContent className="p-6 md:p-8 text-center">
              <div className="bg-accent/10 rounded-full p-4 inline-block mb-4 md:mb-6">
                <TrendingUp className="h-8 w-8 text-accent" />
              </div>
              <h3 className="text-xl font-semibold mb-2 md:mb-4">Planos Inteligentes</h3>
              <p className="text-muted-foreground text-sm md:text-base">
          ...
          <Card className="workchoque-shadow hover:scale-105 workchoque-transition">
            <CardContent className="p-6 md:p-8 text-center">
              ...
              <h3 className="text-xl font-semibold mb-2 md:mb-4">Sistema de Conquistas</h3>
              <p className="text-muted-foreground text-sm md:text-base">
